...
namespace Loaders
{
	...
	public class ExampleReversalTradeOnlyTest : StrategyTest
	{
		...
		public void VerifyCurrentEquity() {
			Assert.AreEqual( Math.Round(9999.50,2),Math.Round(strategy.Performance.Equity.CurrentEquity,2),"current equity");
		}
		[Test]
		public void VerifyOpenEquity() {
			Assert.AreEqual( Math.Round(0.25000,2),Math.Round(strategy.Performance.Equity.OpenEquity,2),"open equity");
		}
		[Test]
		public void VerifyClosedEquity() {
			Assert.AreEqual( Math.Round(9999.250,2),Math.Round(strategy.Performance.Equity.ClosedEquity,2),"open equity");
		}
		[Test]
